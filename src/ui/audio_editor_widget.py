...
from PyQt6.QtCore import Qt, QSettings, QUrl, pyqtSignal, QPointF, QRectF
from PyQt6.QtGui import QColor, QCursor, QPainter, QPen, QPalette, QShortcut, QKeySequence
