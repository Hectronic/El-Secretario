...
from src.ui.summary_queue.worker_runtime import start_next_worker_if_idle
...
class SummaryTaskQueueManager(QObject):
    ...
    def _start_next_if_idle(self):
        return start_next_worker_if_idle(
            state=self._state,
            parent=self,
            db=self.db,
            rag_engine=self.rag_engine,
            clear_wait_state=self._clear_wait_state,
            ...
            set_current_worker=lambda worker: setattr(self, "_current_worker", worker),
