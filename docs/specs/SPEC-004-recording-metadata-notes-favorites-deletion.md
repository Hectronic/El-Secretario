...
- Persistence: note workflows accept injected aggregate persistence; `src/database.py` remains the compatible default facade while `src/persistence/records.py` owns record persistence behavior.
