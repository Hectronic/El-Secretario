# REFACTOR-2026-09-SUMMARY-COMPLETION: Queue Completion, State, And Retry Waits
...
- Preserve completion follow-ups, deduplication, pending ordering, active-task
  transitions, and retry-wait behavior for queued transcription and summaries.
...
- To: `src/app/summary_queue/completion_actions.py` and
  `src/app/summary_queue/state.py`, plus `src/app/summary_queue/wait_state.py`.
