...
| [SPEC-004](SPEC-004-recording-metadata-notes-favorites-deletion.md) | Recording metadata, notes, favorites, deletion | Implemented | `src/database.py`, `src/persistence/records.py`, `src/ui/recording_widget.py`, `src/ui/recording/`, `src/ui/main_window/recording_tabs.py`, `src/ui/note_widget.py`, `src/ui/component_widgets/` | `tests/test_database.py`, `tests/persistence/`, `tests/test_notes.py`, `tests/test_deletion.py`, `tests/test_recording_widget_ui.py`, `tests/ui/recording/`, `tests/ui/main_window/test_recording_tabs.py`, `tests/integration/test_recording_widget_persistence.py` |
| SPEC-005 | Waveform audio editor and safe retranscription | Implemented | `src/ui/audio_editor/`, `src/ui/recording/audio_trim.py`, `src/audio.py`, `src/ui/main_window/recording_tabs.py` | `tests/ui/audio_editor/`, `tests/integration/test_audio_editor_persistence.py`, `tests/ui/recording/test_audio_trim.py`, `tests/test_audio_editing.py`, `tests/test_recording_flow.py` |
| [SPEC-006](SPEC-006-rag-indexing-semantic-search.md) | RAG indexing and semantic search | Implemented | `src/rag_engine.py`, `src/rag/`, `src/ui/main_window/runtime_startup.py`, `src/ui/search_results_widget.py`, `src/ui/main_window/` | `tests/rag/`, `tests/integration/test_rag_engine_contract.py`, `tests/test_rag_engine.py`, `tests/test_rag_fallback.py`, `tests/test_search.py`, `tests/ui/main_window/test_runtime_startup.py` |
| [SPEC-007](SPEC-007-chat-sessions-context-builder-floating-chat.md) | Chat sessions, context builder, and floating chat | Implemented | `src/ui/chat_widget.py`, `src/ui/chat_window.py`, `src/ui/chat/`, `src/ui/context_manager_panel.py`, `src/ui/main_window/chat_floating.py`, `src/ui/main_window/floating_chat_host.py`, `src/ui/component_widgets/sidebar.py` | `tests/test_chat_widget_context.py`, `tests/ui/chat/`, `tests/ui/main_window/test_floating_chat_host.py`, `tests/ui/main_window/test_chat_floating.py`, `tests/integration/test_chat_session_persistence.py`, `tests/integration/test_chat_window_persistence.py` |
| [SPEC-008](SPEC-008-active-chat-context-sidebar.md) | Active chat context sidebar | Implemented | `src/ui/context_manager_panel.py`, `src/ui/context_manager/`, `src/ui/main_window/sidebar_sync.py`, `src/ui/main_window/sidebar_content.py` | `tests/test_chat_context_sync.py`, `tests/ui/context_manager/`, `tests/integration/test_context_manager_panel_sync.py`, `tests/ui/main_window/test_sidebar_sync.py` |
| [SPEC-009](SPEC-009-calendar-navigation-and-date-filtered-context.md) | Calendar navigation and date-filtered context | Implemented | `src/ui/calendar_widget.py`, `src/ui/calendar/`, `src/ui/main_window/sidebar_sync.py`, `src/database.py` | `tests/test_calendar_logic.py`, `tests/test_calendar_ui.py`, `tests/test_calendar_multiselection.py`, `tests/integration/test_calendar_selection_sync.py` |
| [SPEC-010](SPEC-010-collections-tags-and-notebooks.md) | Collections/tags and notebooks | Implemented | `src/ui/collection_widget.py`, `src/ui/notebook_widget.py`, `src/notebook_database.py`, `src/ui/main_window/sidebar_content.py`, `src/ui/main_window/sidebar_organization.py` | `tests/test_notebooks.py`, `tests/ui/main_window/test_sidebar_organization.py`, `tests/ui/main_window/test_window_navigation.py`, `tests/ui/main_window/test_content_tabs.py`, `tests/integration/test_sidebar_content_persistence.py` |
| SPEC-011 | Summaries: recording, daily, weekly, queueing | Implemented | `src/summary_generator.py`, `src/app/summaries/`, `src/persistence/summaries.py`, `src/ui/summary_task_queue.py`, `src/ui/summary_queue/`, `src/app/summary_queue/`, `src/ui/main_window/summary_queue_status.py`, `src/ui/main_window/runtime_startup.py`, `src/ui/summary_viewer.py`, `src/ui/summary_batch_widget.py`, `src/ui/component_widgets/rows.py` | `tests/test_summary_generator_logic.py`, `tests/app/summaries/`, `tests/integration/test_summary_generation_service.py`, `tests/test_summary_queue.py`, `tests/test_summary_task_queue_integration.py`, `tests/ui/summary_queue/`, `tests/ui/main_window/test_summary_queue_status.py`, `tests/ui/main_window/test_runtime_startup.py`, `tests/app/summary_queue/` |
| SPEC-012 | Task extraction and task board/sidebar | Implemented | `src/ui/tasks_list_widget.py`, `src/ui/tasks/`, `src/ui/task_batch_widget.py`, `src/ui/summary_task_queue.py`, `src/persistence/tasks.py`, `src/ui/component_widgets/rows.py`, `src/ui/component_widgets/sidebar.py` | `tests/test_tasks_list_widget.py`, `tests/ui/tasks/`, `tests/integration/test_tasks_board_persistence.py`, `tests/integration/test_component_widgets_task_persistence.py`, `tests/test_pending_summary_counts.py`, `tests/test_tasks_sidebar_calendar_sync.py`, `tests/persistence/` |
| [SPEC-013](SPEC-013-settings-secrets-prompts-theme-and-rag-config.md) | Settings, secrets, prompts, theme, RAG config | Implemented | `src/ui/settings/`, `src/ui/secret_field_widget.py`, `src/ui/styles.py`, `src/ai_provider.py`, `src/ai_providers/` | `tests/test_settings.py`, `tests/ui/settings/`, `tests/ui/test_secret_field_widget.py`, `tests/ai_providers/`, `tests/test_ai_provider_retry.py`, `tests/integration/test_ai_provider_contract.py`, `tests/worker_components/test_settings.py` |
...
| REFACTOR-2026-09-AUDIO-EDITOR-UI | Implemented | Audio-editor Qt composition, selection synchronization, and preview-media lifecycle extraction | SPEC-005, SPEC-002 |
| REFACTOR-2026-09-NOTEBOOK-WIDGET | Implemented | Notebook Qt composition, entry presentation/actions, dialog, and transcription-runtime extraction | SPEC-010, SPEC-002 |
...
| REFACTOR-2026-09-CONTEXT-MANAGER | Implemented | Context-panel Qt composition, state serialization, and entry-resolution extraction | SPEC-008, SPEC-007 |
| REFACTOR-2026-09-TOOLS | Implemented | Tools tab composition, RAG/data actions, and shared batch persistence injection | SPEC-014 |
| REFACTOR-2026-09-CHAT-WIDGET | Implemented | Chat initial-context and display-mode policy extraction | SPEC-007, SPEC-008 |
| REFACTOR-2026-09-CHAT-WINDOW | Implemented | Standalone chat-dialog composition, RAG/session-state extraction, and compatibility facade | SPEC-007 |
| REFACTOR-2026-09-COMPONENT-WIDGETS | Implemented | Reusable tag, sidebar, recording, summary, and task-row widgets split into focused families; `components.py` retained as a compatibility facade | SPEC-004, SPEC-007, SPEC-011, SPEC-012 |
| REFACTOR-2026-09-RAG-ENGINE | Implemented | RAG facade, document mutations, semantic/keyword search switching, and deterministic integration contract | SPEC-006 |
