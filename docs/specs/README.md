...
| [SPEC-006](SPEC-006-rag-indexing-semantic-search.md) | RAG indexing and semantic search | Implemented | `src/rag_engine.py`, `src/rag/`, `src/ui/main_window/runtime_startup.py`, `src/ui/search_results_widget.py`, `src/ui/main_window/` | `tests/rag/`, `tests/rag/test_runtime_policy.py`, `tests/test_rag_engine.py`, `tests/test_rag_fallback.py`, `tests/test_search.py`, `tests/ui/main_window/test_runtime_startup.py` |
