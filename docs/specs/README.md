...
| [SPEC-010](SPEC-010-collections-tags-and-notebooks.md) | Collections/tags and notebooks | Implemented | `src/ui/collection_widget.py`, `src/ui/notebook_widget.py`, `src/notebook_database.py`, `src/ui/main_window/sidebar_content.py` | `tests/test_notebooks.py`, `tests/ui/main_window/test_window_navigation.py`, `tests/ui/main_window/test_content_tabs.py` |
