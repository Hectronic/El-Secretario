...
- La asignación de hablantes en audios largos indexa los turnos una sola vez; pyannote usa lotes CUDA adaptativos si CUDA está disponible y `force_cpu` está desactivado, y reintenta en CPU solo tras un fallo de ejecución de CUDA.
