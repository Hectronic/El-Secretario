...
**Branch**: `015-recording-safety-guardian` | **Status**: Implemented and validated | **Spec**: [spec.md](spec.md)
...
owner of actual stop/save, pause/resume, and cancellation operations.
