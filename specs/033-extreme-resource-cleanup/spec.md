...
- **Testing:** Add unit tests verifying that GC and CUDA cache-empty functions are called upon thread termination, and write a benchmark test demonstrating reduction of idle memory size.
