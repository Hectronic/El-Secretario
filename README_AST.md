...
- L'asignación de falantes n'audios llargos indexa los turnos una sola vez; pyannote usa lotes CUDA adaptativos si CUDA ta disponible y `force_cpu` ta desactiváu, y reintenta en CPU namás tres un fallu d'execución de CUDA.
